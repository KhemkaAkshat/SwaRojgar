...
function OrdersDropdown({ ordersDropdownOpen, setOrdersDropdownOpen }) {
  ...
  const handlePayClick = () => {
    navigate("/custescrow"); // Navigate to the "custescrow" route
  };
        ...
        <div className="p-4">
          ...
          <ul className="">
            <li className="flex items-center text-base">
              ...
              Order #12345
              <button
                className='p-2 bg-green-400 ml-5 rounded-xl text-sm text-white px-4 hover:scale-110 transition-all ease'
                onClick={handlePayClick} // Handle click to navigate
              >
                Pay
              </button>
            </li>
          ...
          <div className="p-4">
            ...
            <ul className="space-y-2 text-base">
              <li className="hover:bg-gray-100 p-2 rounded-md flex justify-between">
                Order #12344
                <button className='text-md text-red-600 px-4'>Paid</button>
              </li>
              <li className="hover:bg-gray-100 p-2 rounded-md flex justify-between">
                Order #12343
                <button className='text-md text-red-600 px-4'>Paid</button>
